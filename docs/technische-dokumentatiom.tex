...
\begin{document}
    ...
    \begin{versionhistory}
        \vhEntry{0.1}{28.06.2023}{Max Riedel}{Erstellung}
        \vhEntry{0.2}{07.07.2023}{Matthias Enderlein}{Füge ER-Diagramm und 2 Sequenzdiagramme hinzu und korrigiere einige Fehler}
        \vhEntry{1.0}{07.07.2023}{Tony Nutzmann}{Füge ein Sequenzdiagramm hinzu und korrigiere einige Fehler}
    \end{versionhistory}
    \newpage
    \tableofcontents
    \newpage
    ...
    \begin{longtable}[htbp]{|p{.20\textwidth}|p{.20\textwidth}|p{.38\textwidth}|p{.12\textwidth}|}
